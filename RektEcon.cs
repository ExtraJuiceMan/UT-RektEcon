    ...
    public class RektEcon : RocketPlugin<RektEconConfiguration>
    {
        ...
        public override TranslationList DefaultTranslations
        {
            get
            {
                ...
                { "command_setbalance_victim", "{0} set your balance to {1}." },
                ...
                { "command_scratch_nowin", "You didn't win anything..." },
                { "command_scratch_win", "You've won {0}{1}!" },
                { "command_scratch_jackpot", "JACKPOT! You've won {0}{1}" },
                { "command_scratch_jackpot_global", "JACKPOT! {0} won {1}{2}" },
                { "command_kick", "{0} KICKED {1}! Reason: \"{2}\"" },
                { "command_kick_failed", "{0} attempted to kick {1}, but that player isn't kickable!" },
